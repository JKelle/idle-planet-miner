...
# TELESCOPE = Item("Telescope", 2_700_000_000, [(LENS, 20), (ADVANCED_COMPUTER, 1)], smelt_time=16_800)
# SATELLITE_DISH = Item("Satellite Dish", 3_400_000_000, [(STEEL_BAR, 150), (PALLADIUM_BAR, 30)], smelt_time=18_000)
# MOTOR = Item("Motor", 7_000_000_000, [(BRONZE_BAR, 500), (HAMMER, 200)], smelt_time=19_200)
