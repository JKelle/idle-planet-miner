 ...
 *
 * `ingredients[].amount` is likewise the game's fixed **base** recipe amount
 * (per the wiki), before any reduction. The Underforge/Dorm Mothership Rooms,
 * the Smelting/Crafting Efficiency projects, and Module ingredient effects
 * are all applied on top of this at runtime by model.js's techMultipliers —
...
const DEFAULT_ENTITIES = [
  ...
  // -------------------------------------------------------------- Alloys ----
  { id: "copper-bar",    name: "Copper Bar",    category: "alloy", basePrice: 1450,    stars: 0, smeltTimeSeconds: 20,   unlockedByDefault: true,  ingredients: [{ sellableId: "copper-ore", amount: 1000 }] },
  { id: "iron-bar",      name: "Iron Bar",      category: "alloy", basePrice: 3000,    stars: 6, smeltTimeSeconds: 30,   unlockedByDefault: true,  ingredients: [{ sellableId: "iron-ore", amount: 1000 }] },
  { id: "lead-bar",      name: "Lead Bar",      category: "alloy", basePrice: 6100,    stars: 5, smeltTimeSeconds: 40,  unlockedByDefault: true,  ingredients: [{ sellableId: "lead-ore", amount: 1000 }] },
  { id: "silicon-bar",   name: "Silicon Bar",   category: "alloy", basePrice: 12500,   stars: 4, smeltTimeSeconds: 60,  unlockedByDefault: true,  ingredients: [{ sellableId: "silicon-ore", amount: 1000 }] },
  { id: "aluminum-bar",  name: "Aluminum Bar",  category: "alloy", basePrice: 27600,   stars: 2, smeltTimeSeconds: 80,  unlockedByDefault: true,  ingredients: [{ sellableId: "aluminum-ore", amount: 1000 }] },
  { id: "silver-bar",    name: "Silver Bar",    category: "alloy", basePrice: 60000,   stars: 4, smeltTimeSeconds: 120,  unlockedByDefault: true,  ingredients: [{ sellableId: "silver-ore", amount: 1000 }] },
  { id: "gold-bar",      name: "Gold Bar",      category: "alloy", basePrice: 120000,  stars: 7, smeltTimeSeconds: 180,  unlockedByDefault: true,  ingredients: [{ sellableId: "gold-ore", amount: 1000 }] },
  { id: "bronze-bar",    name: "Bronze Bar",    category: "alloy", basePrice: 234000,  stars: 1, smeltTimeSeconds: 240,  unlockedByDefault: true,  ingredients: [{ sellableId: "silver-bar", amount: 2 }, { sellableId: "copper-bar", amount: 10 }] },
  { id: "steel-bar",     name: "Steel Bar",     category: "alloy", basePrice: 340000,  stars: 2, smeltTimeSeconds: 480, unlockedByDefault: true,  ingredients: [{ sellableId: "lead-bar", amount: 15 }, { sellableId: "iron-bar", amount: 30 }] },
  { id: "platinum-bar",  name: "Platinum Bar",  category: "alloy", basePrice: 780000,  stars: 4, smeltTimeSeconds: 600, unlockedByDefault: true,  ingredients: [{ sellableId: "gold-bar", amount: 2 }, { sellableId: "platinum-ore", amount: 1000 }] },
  { id: "titanium-bar",  name: "Titanium Bar",  category: "alloy", basePrice: 1630000, stars: 6, smeltTimeSeconds: 720, unlockedByDefault: true,  ingredients: [{ sellableId: "bronze-bar", amount: 2 }, { sellableId: "titanium-ore", amount: 1000 }] },
  { id: "iridium-bar",   name: "Iridium Bar",   category: "alloy", basePrice: 3110000, stars: 1, smeltTimeSeconds: 840, unlockedByDefault: true,  ingredients: [{ sellableId: "steel-bar", amount: 2 }, { sellableId: "iridium-ore", amount: 1000 }] },
  { id: "palladium-bar", name: "Palladium Bar", category: "alloy", basePrice: 7000000, stars: 1, smeltTimeSeconds: 960, unlockedByDefault: true,  ingredients: [{ sellableId: "platinum-bar", amount: 2 }, { sellableId: "palladium-ore", amount: 1000 }] },
  { id: "osmium-bar",    name: "Osmium Bar",    category: "alloy", basePrice: 14500000, stars: 4, smeltTimeSeconds: 1080, unlockedByDefault: true,  ingredients: [{ sellableId: "titanium-bar", amount: 2 }, { sellableId: "osmium-ore", amount: 1000 }] },
  { id: "rhodium-bar",   name: "Rhodium Bar",   category: "alloy", basePrice: 31000000, stars: 2, smeltTimeSeconds: 1200, unlockedByDefault: true,  ingredients: [{ sellableId: "iridium-bar", amount: 2 }, { sellableId: "rhodium", amount: 1000 }] },
  { id: "inerton-alloy", name: "Inerton Alloy", category: "alloy", basePrice: 68000000, stars: 2, smeltTimeSeconds: 1440, unlockedByDefault: true,  ingredients: [{ sellableId: "palladium-bar", amount: 2 }, { sellableId: "inerton", amount: 1000 }] },
  ...
  // --------------------------------------------------------------- Items ----
  { id: "copper-wire",       name: "Copper Wire",       category: "item", basePrice: 10000,   stars: 2, smeltTimeSeconds: 60,   unlockedByDefault: true, ingredients: [{ sellableId: "copper-bar", amount: 5 }] },
  { id: "iron-nails",        name: "Iron Nails",        category: "item", basePrice: 20000,   stars: 3, smeltTimeSeconds: 120,   unlockedByDefault: true, ingredients: [{ sellableId: "iron-bar", amount: 5 }] },
  { id: "battery",           name: "Battery",           category: "item", basePrice: 70000,   stars: 1, smeltTimeSeconds: 240,   unlockedByDefault: true, ingredients: [{ sellableId: "copper-wire", amount: 2 }, { sellableId: "copper-bar", amount: 10 }] },
  { id: "hammer",            name: "Hammer",            category: "item", basePrice: 135000,  stars: 3, smeltTimeSeconds: 480,  unlockedByDefault: true, ingredients: [{ sellableId: "iron-nails", amount: 2 }, { sellableId: "lead-bar", amount: 5 }] },
  { id: "glass",             name: "Glass",             category: "item", basePrice: 220000,  stars: 5, smeltTimeSeconds: 720,  unlockedByDefault: true, ingredients: [{ sellableId: "silicon-bar", amount: 10 }] },
  { id: "circuit",           name: "Circuit",           category: "item", basePrice: 620000,  stars: 1, smeltTimeSeconds: 1200,  unlockedByDefault: true, ingredients: [{ sellableId: "silicon-bar", amount: 5 }, { sellableId: "aluminum-bar", amount: 5 }, { sellableId: "copper-wire", amount: 10 }] },
  { id: "lens",              name: "Lens",              category: "item", basePrice: 1100000, stars: 4, smeltTimeSeconds: 2400,  unlockedByDefault: true, ingredients: [{ sellableId: "glass", amount: 1 }, { sellableId: "silver-bar", amount: 5 }] },
  { id: "laser",             name: "Laser",             category: "item", basePrice: 3200000, stars: 3, smeltTimeSeconds: 3600,  unlockedByDefault: true, ingredients: [{ sellableId: "gold-bar", amount: 5 }, { sellableId: "lens", amount: 1 }, { sellableId: "iron-bar", amount: 10 }] },
  { id: "basic-computer",    name: "Basic Computer",    category: "item", basePrice: 7600000, stars: 3, smeltTimeSeconds: 4800, unlockedByDefault: true, ingredients: [{ sellableId: "circuit", amount: 5 }, { sellableId: "silver-bar", amount: 5 }] },
  { id: "solar-panel",       name: "Solar Panel",       category: "item", basePrice: 12500000, stars: 2, smeltTimeSeconds: 6000, unlockedByDefault: true, ingredients: [{ sellableId: "circuit", amount: 5 }, { sellableId: "glass", amount: 10 }] },
  { id: "laser-torch",       name: "Laser Torch",       category: "item", basePrice: 31000000, stars: 3, smeltTimeSeconds: 7200, unlockedByDefault: true, ingredients: [{ sellableId: "bronze-bar", amount: 5 }, { sellableId: "laser", amount: 2 }, { sellableId: "lens", amount: 5 }] },
  { id: "advanced-battery",  name: "Advanced Battery",  category: "item", basePrice: 35000000, stars: 3, smeltTimeSeconds: 9000, unlockedByDefault: true, ingredients: [{ sellableId: "steel-bar", amount: 20 }, { sellableId: "battery", amount: 30 }] },
  { id: "thermal-scanner",   name: "Thermal Scanner",   category: "item", basePrice: 71500000, stars: 2, smeltTimeSeconds: 10800, unlockedByDefault: true, ingredients: [{ sellableId: "platinum-bar", amount: 5 }, { sellableId: "laser", amount: 2 }, { sellableId: "glass", amount: 5 }] },
  { id: "advanced-computer", name: "Advanced Computer", category: "item", basePrice: 180000000, stars: 1, smeltTimeSeconds: 12600, unlockedByDefault: true, ingredients: [{ sellableId: "titanium-bar", amount: 5 }, { sellableId: "basic-computer", amount: 5 }] },
  { id: "navigation-module", name: "Navigation Module", category: "item", basePrice: 1000000000, stars: 2, smeltTimeSeconds: 13500, unlockedByDefault: true, ingredients: [{ sellableId: "thermal-scanner", amount: 1 }, { sellableId: "laser-torch", amount: 2 }] },
  { id: "plasma-torch",      name: "Plasma Torch",      category: "item", basePrice: 1150000000, stars: 0, smeltTimeSeconds: 15000, unlockedByDefault: true, ingredients: [{ sellableId: "iridium-bar", amount: 15 }, { sellableId: "laser-torch", amount: 5 }] },
  { id: "radio-tower",       name: "Radio Tower",       category: "item", basePrice: 1450000000, stars: 0, smeltTimeSeconds: 15600, unlockedByDefault: true, ingredients: [{ sellableId: "platinum-bar", amount: 75 }, { sellableId: "aluminum-bar", amount: 150 }, { sellableId: "titanium-bar", amount: 50 }] },
  { id: "telescope",         name: "Telescope",         category: "item", basePrice: 2700000000, stars: 1, smeltTimeSeconds: 16800, unlockedByDefault: true, ingredients: [{ sellableId: "lens", amount: 20 }, { sellableId: "advanced-computer", amount: 1 }] },
  { id: "satellite-dish",    name: "Satellite Dish",    category: "item", basePrice: 3400000000, stars: 0, smeltTimeSeconds: 18000, unlockedByDefault: true, ingredients: [{ sellableId: "steel-bar", amount: 150 }, { sellableId: "palladium-bar", amount: 30 }] },
  { id: "motor",             name: "Motor",             category: "item", basePrice: 7000000000, stars: 0, smeltTimeSeconds: 19200, unlockedByDefault: true, ingredients: [{ sellableId: "bronze-bar", amount: 500 }, { sellableId: "hammer", amount: 200 }] },
  ...
  { id: "phase-gate",           name: "Phase Gate",           category: "item", basePrice: 452000000000000000000000000000000, stars: 0, smeltTimeSeconds: 699000, unlockedByDefault: false, ingredients: [{ sellableId: "deep-space-scanner", amount: 70 }, { sellableId: "advanced-teleporter", amount: 350 }, { sellableId: "orbital-dock", amount: 1 }] },
