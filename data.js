...
const DEFAULT_ENTITIES = [
  ...
  // -------------------------------------------------------------- Alloys ----
  { id: "copper-bar",    name: "Copper Bar",    category: "alloy", basePrice: 1450,    stars: 0, smeltTimeSeconds: 20,   unlockedByDefault: true,  ingredients: [{ sellableId: "copper-ore", amount: 560 }] },
  { id: "iron-bar",      name: "Iron Bar",      category: "alloy", basePrice: 3000,    stars: 6, smeltTimeSeconds: 30,   unlockedByDefault: true,  ingredients: [{ sellableId: "iron-ore", amount: 560 }] },
  { id: "lead-bar",      name: "Lead Bar",      category: "alloy", basePrice: 6100,    stars: 5, smeltTimeSeconds: 40,  unlockedByDefault: true,  ingredients: [{ sellableId: "lead-ore", amount: 560 }] },
  { id: "silicon-bar",   name: "Silicon Bar",   category: "alloy", basePrice: 12500,   stars: 4, smeltTimeSeconds: 60,  unlockedByDefault: true,  ingredients: [{ sellableId: "silicon-ore", amount: 560 }] },
  { id: "aluminum-bar",  name: "Aluminum Bar",  category: "alloy", basePrice: 27600,   stars: 2, smeltTimeSeconds: 80,  unlockedByDefault: true,  ingredients: [{ sellableId: "aluminum-ore", amount: 560 }] },
  { id: "silver-bar",    name: "Silver Bar",    category: "alloy", basePrice: 60000,   stars: 4, smeltTimeSeconds: 120,  unlockedByDefault: true,  ingredients: [{ sellableId: "silver-ore", amount: 560 }] },
  { id: "gold-bar",      name: "Gold Bar",      category: "alloy", basePrice: 120000,  stars: 7, smeltTimeSeconds: 180,  unlockedByDefault: true,  ingredients: [{ sellableId: "gold-ore", amount: 560 }] },
  { id: "bronze-bar",    name: "Bronze Bar",    category: "alloy", basePrice: 234000,  stars: 1, smeltTimeSeconds: 240,  unlockedByDefault: true,  ingredients: [{ sellableId: "silver-bar", amount: 1 }, { sellableId: "copper-bar", amount: 6 }] },
  { id: "steel-bar",     name: "Steel Bar",     category: "alloy", basePrice: 340000,  stars: 2, smeltTimeSeconds: 480, unlockedByDefault: true,  ingredients: [{ sellableId: "lead-bar", amount: 8 }, { sellableId: "iron-bar", amount: 17 }] },
  { id: "platinum-bar",  name: "Platinum Bar",  category: "alloy", basePrice: 780000,  stars: 4, smeltTimeSeconds: 600, unlockedByDefault: true,  ingredients: [{ sellableId: "gold-bar", amount: 1 }, { sellableId: "platinum-ore", amount: 560 }] },
  { id: "titanium-bar",  name: "Titanium Bar",  category: "alloy", basePrice: 1630000, stars: 6, smeltTimeSeconds: 720, unlockedByDefault: true,  ingredients: [{ sellableId: "bronze-bar", amount: 1 }, { sellableId: "titanium-ore", amount: 560 }] },
  { id: "iridium-bar",   name: "Iridium Bar",   category: "alloy", basePrice: 3110000, stars: 1, smeltTimeSeconds: 840, unlockedByDefault: true,  ingredients: [{ sellableId: "steel-bar", amount: 1 }, { sellableId: "iridium-ore", amount: 560 }] },
  { id: "palladium-bar", name: "Palladium Bar", category: "alloy", basePrice: 7000000, stars: 1, smeltTimeSeconds: 960, unlockedByDefault: true,  ingredients: [{ sellableId: "platinum-bar", amount: 1 }, { sellableId: "palladium-ore", amount: 560 }] },
  { id: "osmium-bar",    name: "Osmium Bar",    category: "alloy", basePrice: 14500000, stars: 4, smeltTimeSeconds: 1080, unlockedByDefault: true,  ingredients: [{ sellableId: "titanium-bar", amount: 1 }, { sellableId: "osmium-ore", amount: 560 }] },
  { id: "rhodium-bar",   name: "Rhodium Bar",   category: "alloy", basePrice: 31000000, stars: 2, smeltTimeSeconds: 1200, unlockedByDefault: true,  ingredients: [{ sellableId: "iridium-bar", amount: 1 }, { sellableId: "rhodium", amount: 560 }] },
  { id: "inerton-alloy", name: "Inerton Alloy", category: "alloy", basePrice: 68000000, stars: 2, smeltTimeSeconds: 1440, unlockedByDefault: true,  ingredients: [{ sellableId: "palladium-bar", amount: 1 }, { sellableId: "inerton", amount: 560 }] },
  ...
  // --------------------------------------------------------------- Items ----
  { id: "copper-wire",       name: "Copper Wire",       category: "item", basePrice: 10000,   stars: 2, smeltTimeSeconds: 60,   unlockedByDefault: true, ingredients: [{ sellableId: "copper-bar", amount: 2 }] },
  { id: "iron-nails",        name: "Iron Nails",        category: "item", basePrice: 20000,   stars: 3, smeltTimeSeconds: 120,   unlockedByDefault: true, ingredients: [{ sellableId: "iron-bar", amount: 2 }] },
  { id: "battery",           name: "Battery",           category: "item", basePrice: 70000,   stars: 1, smeltTimeSeconds: 240,   unlockedByDefault: true, ingredients: [{ sellableId: "copper-wire", amount: 1 }, { sellableId: "copper-bar", amount: 4 }] },
  { id: "hammer",            name: "Hammer",            category: "item", basePrice: 135000,  stars: 3, smeltTimeSeconds: 480,  unlockedByDefault: true, ingredients: [{ sellableId: "iron-nails", amount: 1 }, { sellableId: "lead-bar", amount: 2 }] },
  { id: "glass",             name: "Glass",             category: "item", basePrice: 220000,  stars: 5, smeltTimeSeconds: 720,  unlockedByDefault: true, ingredients: [{ sellableId: "silicon-bar", amount: 4 }] },
  { id: "circuit",           name: "Circuit",           category: "item", basePrice: 620000,  stars: 1, smeltTimeSeconds: 1200,  unlockedByDefault: true, ingredients: [{ sellableId: "silicon-bar", amount: 2 }, { sellableId: "aluminum-bar", amount: 2 }, { sellableId: "copper-wire", amount: 4 }] },
  { id: "lens",              name: "Lens",              category: "item", basePrice: 1100000, stars: 4, smeltTimeSeconds: 2400,  unlockedByDefault: true, ingredients: [{ sellableId: "glass", amount: 1 }, { sellableId: "silver-bar", amount: 2 }] },
  { id: "laser",             name: "Laser",             category: "item", basePrice: 3200000, stars: 3, smeltTimeSeconds: 3600,  unlockedByDefault: true, ingredients: [{ sellableId: "gold-bar", amount: 2 }, { sellableId: "lens", amount: 1 }, { sellableId: "iron-bar", amount: 4 }] },
  { id: "basic-computer",    name: "Basic Computer",    category: "item", basePrice: 7600000, stars: 3, smeltTimeSeconds: 4800, unlockedByDefault: true, ingredients: [{ sellableId: "circuit", amount: 2 }, { sellableId: "silver-bar", amount: 2 }] },
  { id: "solar-panel",       name: "Solar Panel",       category: "item", basePrice: 12500000, stars: 2, smeltTimeSeconds: 6000, unlockedByDefault: true, ingredients: [{ sellableId: "circuit", amount: 2 }, { sellableId: "glass", amount: 4 }] },
  { id: "laser-torch",       name: "Laser Torch",       category: "item", basePrice: 31000000, stars: 3, smeltTimeSeconds: 7200, unlockedByDefault: true, ingredients: [{ sellableId: "bronze-bar", amount: 2 }, { sellableId: "laser", amount: 1 }, { sellableId: "lens", amount: 2 }] },
  { id: "advanced-battery",  name: "Advanced Battery",  category: "item", basePrice: 35000000, stars: 3, smeltTimeSeconds: 9000, unlockedByDefault: true, ingredients: [{ sellableId: "steel-bar", amount: 9 }, { sellableId: "battery", amount: 13 }] },
  { id: "thermal-scanner",   name: "Thermal Scanner",   category: "item", basePrice: 71500000, stars: 2, smeltTimeSeconds: 10800, unlockedByDefault: true, ingredients: [{ sellableId: "platinum-bar", amount: 2 }, { sellableId: "laser", amount: 1 }, { sellableId: "glass", amount: 2 }] },
  { id: "advanced-computer", name: "Advanced Computer", category: "item", basePrice: 180000000, stars: 1, smeltTimeSeconds: 12600, unlockedByDefault: true, ingredients: [{ sellableId: "titanium-bar", amount: 2 }, { sellableId: "basic-computer", amount: 2 }] },
  { id: "navigation-module", name: "Navigation Module", category: "item", basePrice: 1000000000, stars: 2, smeltTimeSeconds: 13500, unlockedByDefault: true, ingredients: [{ sellableId: "thermal-scanner", amount: 1 }, { sellableId: "laser-torch", amount: 1 }] },
  { id: "plasma-torch",      name: "Plasma Torch",      category: "item", basePrice: 1150000000, stars: 0, smeltTimeSeconds: 15000, unlockedByDefault: true, ingredients: [{ sellableId: "iridium-bar", amount: 6 }, { sellableId: "laser-torch", amount: 2 }] },
  { id: "radio-tower",       name: "Radio Tower",       category: "item", basePrice: 1450000000, stars: 0, smeltTimeSeconds: 15600, unlockedByDefault: true, ingredients: [{ sellableId: "platinum-bar", amount: 32 }, { sellableId: "aluminum-bar", amount: 65 }, { sellableId: "titanium-bar", amount: 22 }] },
  { id: "telescope",         name: "Telescope",         category: "item", basePrice: 2700000000, stars: 1, smeltTimeSeconds: 16800, unlockedByDefault: true, ingredients: [{ sellableId: "lens", amount: 9 }, { sellableId: "advanced-computer", amount: 1 }] },
  { id: "satellite-dish",    name: "Satellite Dish",    category: "item", basePrice: 3400000000, stars: 0, smeltTimeSeconds: 18000, unlockedByDefault: true, ingredients: [{ sellableId: "steel-bar", amount: 65 }, { sellableId: "palladium-bar", amount: 13 }] },
  { id: "motor",             name: "Motor",             category: "item", basePrice: 7000000000, stars: 0, smeltTimeSeconds: 19200, unlockedByDefault: true, ingredients: [{ sellableId: "bronze-bar", amount: 216 }, { sellableId: "hammer", amount: 86 }] },
